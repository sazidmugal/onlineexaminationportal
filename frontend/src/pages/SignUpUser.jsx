...
function SignUpUser() {
  const [formData, setFormData] = useState({ name: '', password: '', roles: 'ROLE_USER' });
  ...
  return (
    <div style={styles.container}>
      <div style={styles.card}>
        ...
        <p style={styles.subtitle}>Create an account to take exams</p>
        ...
        <form onSubmit={handleSubmit} style={styles.form}>
          ...
          <button type="submit" style={styles.primaryBtn}>Register as Student</button>
        </form>
...
const styles = {
  ...
  card: { width: '100%', maxWidth: '400px', padding: '32px', backgroundColor: '#1e293b', borderRadius: '10px', border: '1px solid #334155' },
  title: { margin: 0, fontSize: '24px', fontWeight: 'bold', textAlign: 'center' },
  ...
  primaryBtn: { padding: '12px', backgroundColor: '#10b981', color: '#fff', border: 'none', borderRadius: '6px', fontWeight: 'bold', cursor: 'pointer' },
